...
class CreditCardLight extends Component {
    state ={
            ...
            <div className={"row"}>
                <div className="col-md-8">
                    ...
                    <form className="needs-validation">
                        ...
                        <div className="mb-3">
                            <input className="form-check-input" type="checkbox" value="" id="bills" />
                        ...
                        <div className="mb-3">
                            <input className="form-check-input" type="checkbox" value="" id="tandc" />
                            <label  className="form-check-label" htmlFor="tandc">
                                I accept the <a className={"text-danger"} onClick={this.showTerms}>terms and conditions</a> of purchase
                            </label>
